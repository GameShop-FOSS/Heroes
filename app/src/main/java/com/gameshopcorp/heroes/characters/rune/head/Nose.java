...
public class Nose {
    ...
    Node node;
    public Nose(SimpleApplication app, Vector3f axis, Node node) {
    ...
    public void addEdgeCurrencyLines() {
        ...
        //Top Of Head
        frontTop = new CurrencyLine(new Vector3f[]{corners[1], axis.add(new Vector3f(1, 3, -2f)), axis.add(new Vector3f(2, 3f, -2f)), corners[2]}, (byte) 16);
        ...
        frontRight = new CurrencyLine(new Vector3f[]{corners[0], axis.add(new Vector3f(0, 1, -1.5f)), axis.add(new Vector3f(0, 2, -1.75f)), corners[1]}, (byte) 16);
        frontLeft = new CurrencyLine(new Vector3f[]{corners[3], axis.add(new Vector3f(3, 1, -1.5f)), axis.add(new Vector3f(3, 2, -1.75f)), corners[2]}, (byte) 16);
        ...
        topLeft = new CurrencyLine(new Vector3f[]{corners[6], axis.add(new Vector3f(3, 3, -2.75f)), axis.add(new Vector3f(3f, 3, -1.75f)), corners[2]}, (byte) 16);
        topRight = new CurrencyLine(new Vector3f[]{corners[5], axis.add(new Vector3f(0, 3, -2.75f)), axis.add(new Vector3f(0, 3, -1.75f)), corners[1]}, (byte) 16);
